...
def get_achievements_steam_single(user_id, key, app_id):
    ...
    response = get("http://api.steampowered.com/ISteamUserStats/GetPlayerAchievements/v0001/?appid=" + str(app_id) + "&key="+ key + "&steamid=" + str(user_id))
    #build json object
    achievement_list = response.json()
